...
class PyChain:
    ...
    def add_block(self, candidate_block):
        ...
        self.chain += [block]
# Added streamlit write for validity test
    def is_valid(self):
...
# Initializing - maybe not necessary but just in case.
snd = ""
rcv = ""
amt = 0.00

# Removed the buttons for the inputs. They weren't necessary and 
# weren't implementing correctly.

# @TODO:
# Add an input area where you can get a value for `sender` from the user.
# YOUR CODE HERE
snd = st.text_input("Sender")


# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
# YOUR CODE HERE
rcv = st.text_input("Receiver")
...
# Added streamlit text for validity test
